...
namespace XmlRpc.MethodCalls
{
    ...
    public abstract class MethodCall<TParam1, TParam1Base, TParam2, TParam2Base, TParam3, TParam3Base, TReturn, TReturnBase>
        : MethodCall<TParam1, TParam1Base, TParam2, TParam2Base, TReturn, TReturnBase>
        ...
        where TReturn : XmlRpcType<TReturnBase>, new()
    {
        ...
        protected MethodCall(TParam1Base param1, TParam2Base param2, TParam3Base param3)
            : base(param1, param2)
        {
        ...
        protected override XElement generateParamsXml()
        {
            ...
            paramsElement.Add(new XElement(XName.Get(ParamElement), new XElement(XName.Get(ValueElement), param3.GenerateXml())));
