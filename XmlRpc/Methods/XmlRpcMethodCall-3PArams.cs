...
namespace XmlRpc.Methods
{
        ...
        where TReturn : XmlRpcType<TReturnBase>, new()
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="XmlRpc.Methods.XmlRpcMethodCall&lt;TParam1, TParam1Base, TParam2, TParam2Base, TParam3, TParam3Base, TReturn, TReturnBase&gt;"/>
